//********************************************************************************************************************************
//*                                                                                                                              *
//*     MP4 Tag Library 1.0.34.75 © 3delite 2012-2017                                                                            *
...
Const
    MP4TAGLIBRARY_VERSION = $01003475;
    MP4TAGLIBRARY_VERSION_FRIENDLY = '1.0.34.75 (Ivan Llanas branch)';
...
type
    ...
    public
        ...
        property mdatAtomSize: UInt64 read FmdatAtomSize;
        ...
        property AudioSampleRate: Integer read FAudioSampleRate;
...
begin
    ...
    try
        ...
        //* Get mdat atom size
        FmdatAtomSize := GetmdatAtomSize(MP4Stream);
        //* Get play time
...
{$ENDIF}
        if FPlayTime <> 0 then begin
            FBitRate := Trunc((FmdatAtomSize / FPlayTime / 125) + 0.5);
        end;
        //* Continue loading
