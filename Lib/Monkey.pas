...
begin
   ...
   TagSize := 0;
   if FID3v1.Valid  then inc(TagSize, 128);
   if FID3v2.Valid  then inc(TagSize, FID3v2.Size);
   if FAPEtag.Valid then inc(TagSize, FAPETag.Size);
